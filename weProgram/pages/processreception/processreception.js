// pages/processreception/processreception.js
const app = getApp()
...
Page({
  ...
  data: {
    ...
    processInstances: null,     //需要接收的项目实例
  ...
  onShow: function () {
    ...
    wx.request({
      url: app.globalData.serverAddress + '/activity/api/area/taskReceiver/getReceiverInstance',
      data: requestData,
      method: 'POST',
      header: {
