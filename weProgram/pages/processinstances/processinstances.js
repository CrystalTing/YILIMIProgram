// pages/processinstances/processinstances.js
const app = getApp()
...
Page({
  ...
  onShow: function () {
    ...
    wx.request({
      url: app.globalData.serverAddress + '/activity/api/process/getInvolvedProcessInstances',
      data: requestData,
      method: 'POST',
      header: {
